...
:draw_next_initial
	...
	= w (/ w 2)
	= dx2 (- dx2 w)
	font_draw small_font 251 242 54 255 s dx2 dy
	= dx (+ dx 50)
	= i (+ i 1)
	? i num_set
...
:draw_curr
	...
	= w (/ w 2)
	= dx2 (- dx2 w)
	font_draw small_font 251 242 54 255 curr dx2 dy
...
function run
{
	...
	= num_set (+ num_set 1)
	= inst (mml_play enter_sfx 1 0)
	? num_set 3
	jl no_press
	var name
	var c1 c2 c3
	explode initials c1 c2 c3
	= name c1
	= name (+ name c2 c3)
